...
describe('integration errors', () => {
  it('IntegrationNotConnectedError has correct properties', () => {
    const err = new IntegrationNotConnectedError('example-company', 'google', 'user@example.com')
    ...
    expect(err.account).toBe('user@example.com')
    expect(err instanceof Error).toBe(true)
  })

  it('TokenExpiredError has correct properties', () => {
    const err = new TokenExpiredError('example-company', 'google', 'user@example.com')
  ...
  it('InsufficientScopeError lists missing scopes', () => {
    const err = new InsufficientScopeError('example-company', 'google', 'user@example.com', ['drive', 'calendar'])
